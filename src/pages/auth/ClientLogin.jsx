        ...
        <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-xl shadow-gray-200/50 w-full max-w-md p-8 border border-gray-100">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500 mt-2">Manage your restaurant and orders</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-1">
                            ...
                            <Link to={`/client/${slug}/forgot-password`} className="text-xs font-bold text-brand-600 hover:text-brand-700">
                                Forgot password?
                            </Link>
                        </div>
                        <input
